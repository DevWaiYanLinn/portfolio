      ...
      <div className="mt-6 flex justify-between flex-wrap">
        <div className="md:w-[70%] xs:w-full xs:mb-5 md:mb-0">
          ...
          <p className="mt-3 xs:text-sm md:text-inherit !leading-7">
            ...
            JavaScript, MongoDB, React, and other cutting-edge technologies.<br></br><br></br>
            My first professional step led me to META TEAM MYANMAR CO., LTD, where
            I served as a junior developer. During my tenure, I had the
            ...
            in honing my technical prowess.<br></br><br></br> Beyond my professional commitments,
            I find immense joy in sharing knowledge and mentoring newcomers to
            the world of technology. I'm particularly enthusiastic about
            exploring contemporary technologies like React, Vue, and Solid.js.
            <br></br> When I'm not immersed in the world of coding and technology, you'll
            often find me indulging in my hobbies, which include both coding
            challenges and the serene art of swimming.<br></br><br></br> Currently, I'm dedicated
            to expanding my horizons even further. I'm actively pursuing
            proficiency in the Japanese language and exploring the exciting
            field of Artificial Intelligence through courses at Metro IT &
            Japanese Language Center. My ultimate goal is to bring my skills and
            passion to the dynamic tech scene of Japan, where I aspire to work
            and thrive for the foreseeable future.<br></br><br></br> Thank you for taking a moment
            to get to know me and my aspirations.
          </p>
        </div>
